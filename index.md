...
- в каждой статье устанавливаем теги соответсвующей специализации или технологии
В самом начале текста статьи
...
![ExsampleAddFile](./Images/Index5.png "Пример тега")
...
- каждая захардкоженная переменная в скрипте должна быть описана (для чего нужна и какие функции выполняет) если есть логика основанная на хардкоде то она должна быть детальна описана и какие ждут последствия ее изменения 
